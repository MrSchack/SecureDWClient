...
public final class ExportExternalToolsCommand extends Command {
    ...
    public static int actionId() {
        final Integer cmdId =
            Ide.findCmdID("oracle.ide.extsamples.externaltoolimportexport.exportexternaltools");
        if (cmdId == null)
            throw new IllegalStateException("Action oracle.ide.extsamples.externaltoolimportexport.exportexternaltools not found.");
        return cmdId;
    }
}
