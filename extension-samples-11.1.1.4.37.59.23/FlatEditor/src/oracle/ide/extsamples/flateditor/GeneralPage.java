/* $Header: GeneralPage.java 16-aug-2007.22:08:25 bduff Exp $ */
...
final class GeneralPage extends TransparentPanel {
    GeneralPage() {
        layoutComponents();
    }
    ...
    private class StuffPanel extends TransparentPanel {
        StuffPanel() {
    ...
    private class PanelWithTwoTables extends TransparentPanel {
        PanelWithTwoTables() {
            setLayout(new VerticalFlowLayout());
