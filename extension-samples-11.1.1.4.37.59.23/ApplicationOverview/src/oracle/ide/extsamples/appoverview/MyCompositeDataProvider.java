/* $Header: jdev/src/esdk-samples/sample/ApplicationOverview/src/oracle/ide/extsamples/appoverview/MyCompositeDataProvider.java /main/11 2009/05/14 11:15:47 dlane Exp $ */
...
public final class MyCompositeDataProvider extends CompositeDataProvider {
    ...
    public void determineContentForProject(Project project) {
        ...
        handleIndicatorURLs(project);

        // Next handle files that will belong to the composite
        handleIndicatorChildURLs(project);
    }
     ...
     */
    private void handleIndicatorURLs(final Project project) {
        ...
        searchIndex(project, criteria, new Callback<List<URL>>() {
     ...
     * @param project the project to search
     */
    private void handleIndicatorChildURLs(final Project project) {
