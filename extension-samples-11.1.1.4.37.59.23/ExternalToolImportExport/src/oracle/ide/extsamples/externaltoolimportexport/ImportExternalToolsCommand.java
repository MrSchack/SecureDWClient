...
public final class ImportExternalToolsCommand extends Command {
    ...
    public static int actionId() {
        final Integer cmdId =
            Ide.findCmdID("oracle.ide.extsamples.externaltoolimportexport.importexternaltools");
        if (cmdId == null)
            throw new IllegalStateException("Action oracle.ide.extsamples.externaltoolimportexport.importexternaltools not found.");
        return cmdId;
    }
}
