...
public class SamplePalettePage extends DefaultPalettePage {
    ...
    public SamplePalettePage(String pageId, String pageName,
                             String pageDescription, String pageIcon,
                             String pageType, String pageShowForTypes,
        ...
        final StringTokenizer tknTypes =
            new StringTokenizer(pageShowForTypes, ";"); //NOTRANS
        ...
        final StringTokenizer tknScopes =
            new StringTokenizer(pageTechnologyScope, ";"); //NOTRANS
